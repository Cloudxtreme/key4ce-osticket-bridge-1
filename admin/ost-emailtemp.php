...
<div style="clear: both"></div>
<div style="padding-left:15px;padding-bottom:2px;padding-top:10px;"><b>*<?php echo __("Admin Create Ticket Email", 'key4ce-osticket-bridge'); ?></b>&nbsp;&raquo;&nbsp;<a href="javascript:doMenu('main3');" id="xmain3">[<?php echo __("Close", 'key4ce-osticket-bridge'); ?>]</a></div>
<div style="clear: both"></div>
<div id="main3" style="display: block;">
<form name="ost-admin-new-ticket" action="admin.php?page=ost-emailtemp" method="post">
<div style="margin-bottom: 10px;"><label style="margin-left:22px; font-weight: bold;">Admin Create Ticket Email Template Subject :  </label>
...
<textarea name="form_adminnewticket" rows="18" id="emailtemp" value=""><?php echo $adminnewticket_text; ?></textarea>
<div style="clear: both"></div>
<div align="center">
<input type="submit" name="ost-admin-new-ticket" class="key4ce_button-primary" value="<?php echo __("Save - Admin Create Ticket Email", 'key4ce-osticket-bridge'); ?>" />
</div>
</form>
</div>
...
<?php echo $form_admintreply_subject; ?>
