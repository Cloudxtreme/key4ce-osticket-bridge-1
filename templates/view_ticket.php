...
$allowedExts = explode(",", $strplc);
	...
	.entry-content{max-width: 700px !important;}
    </style>
    ...
    <div id="key4ce_tic_info_box">
        ...
        <div id="key4ce_tic_created_date"><?php echo date($datetime_format, strtotime($ticketinfo->created)); ?></div>
		...
		<div style="clear: both"></div>
		<div id="key4ce_tic_topic"><?php echo __("Help Topic", 'key4ce-osticket-bridge'); ?>:</div>
        <div id="key4ce_tic_help_topic"><?php echo $ticketinfo->topic; ?></div>
        <div style="clear: both"></div>
    </div>
    ...
    foreach ($threadinfo as $thread_info) {
        ...
        ?>
                <table style="width:100%; border: 1px solid #aaa; border-bottom: 2px solid #aaa;" cellspacing="0" cellpadding="1" border="0" class="<?php echo $thread_info->thread_type; ?>">
                    <tbody>
                        <tr>
                            <th><?php echo date($datetime_format, strtotime($thread_info->created)); ?><span id="key4ce_ticketThread"><?php if ($hidename == 1 && $thread_info->thread_type <> "M") {
    ...
    <?php } ?>
        ...
        <table class="key4ce_welcome key4ce_nobd" align="left" width="95%" cellspacing="0" cellpadding="3">            
                <tr>
                    <td class="key4ce_nobd" align="center">						<?php						//Note : $poconsubmail variable coming from /osticket-wp.php file						if($poconsubmail!="")							$userpost_subject=$poconsubmail;						else							$userpost_subject=$ticketinfo->subject;						?>
