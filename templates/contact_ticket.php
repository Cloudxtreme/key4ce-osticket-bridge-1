...
?>	
<!-- Help Topic Start Here --><div id="key4ce_new_ticket_helptopic_loader" style="display:none;text-align: center;width: 220px;">			<img src="<?php echo plugins_url('images/key4ce_loader.gif',dirname(__FILE__)); ?>" alt="<?php echo __("Loading...", 'key4ce-osticket-bridge'); ?>"></div>
