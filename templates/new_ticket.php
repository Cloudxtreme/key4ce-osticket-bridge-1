...
$user_id=$ost_wpdb->get_var("SELECT user_id FROM " . $keyost_prefix . "user_email WHERE `address` = '" . $current_user->user_email . "'");
    ...
    <div id="key4ce_new_ticket">
        ...
        <form id="ticketForm" name="newticket" method="post" enctype="multipart/form-data" onsubmit="return validateFormNewTicket();">
            ...
            <div id="key4ce_new_ticket_subject_input"><input class="ost" id="subject" type="text" name="subject" size="35"/><font class="key4ce_error">&nbsp;*</font></div>
            <div style="clear: both"></div>
            ...
            <div id="key4ce_new_ticket_catagory_input">
                ...
                <option value="0" selected="selected"><?php echo __('Select a Category','key4ce-osticket-bridge'); ?></option>
                <?php
			...
			<div id="key4ce_new_ticket_helptopic" style="display:none;"><?php echo __('Help Topic','key4ce-osticket-bridge'); ?>:</div>
    ...
    <table class="key4ce_welcome key4ce_nobd" align="center" width="95%" cellpadding="3" cellspacing="3" border="0">
        ...
        <center> <?php
            ...
            ?> <textarea id="message" name="message" style="width: 100%; height: 150px"></textarea></center>
