...
<div id="key4ce_ticket_menu5"><?php echo __("Help Topic", 'key4ce-osticket-bridge'); ?></div>
<div id="key4ce_ticket_menu6"><?php echo __("Date", 'key4ce-osticket-bridge'); ?></div>
</div>
<?php
	function ezDate($d) {
	...
	echo "<div id='key4ce_ticket_list5'>".$list->topic."</div>"; 
    if ($list->updated=='0000-00-00 00:00:00') {
		$input_str  = "".$list->created.""; }
		else {
   	$input_str  = "".$list->updated.""; }
   	echo "<div id='key4ce_ticket_list6'>"; 		echo date($datetime_format, strtotime($input_str));
   	echo "</div>"; 
