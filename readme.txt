...
= Basic Features: =
* Compatible with osTicket 1.9.3 - 1.9.12
...
* Make sure that your osTicket version is 1.9.3, 1.9.4 1.9.5, 1.9.6, 1.9.8, 1.9.9, 1.9.10, 1.9.11 or 1.9.12 (all subversions should work).
...
* Our plugin will make use of Department, help topic alert & Email settings. Please set them carefully in osTicket settings.
...
* Make sure the email template subject matches your osticket email subjects.
* Fill in google's re-captcha code for contact page.
...
6. Add a contact page and a thank you page for [addoscontact]
7. Set the landing page (ticket list + create ticket page)
8. Set the contact page and Contact thank you page
9. Set googles re-captcha keys for the contact page (can be found at: https://www.google.com/recaptcha/admin#list)
...
osTicket v1.9.3 to v1.9.12 (all subversions are generally supported).
...
== Upgrade Notice ==
= 1.3.3 = 
Fixes minor bugs including some multi-language bugs.

= 1.3.2 = 
Minor bug fixes to solve some issues that occured after update 1.3.1.

= 1.3.1 =
added help topic based up on department, contact form department, help topic and attachments options added, added support for osticket 1.9.12

= 1.3.0 = 
Added help topic functionality, added email subjects to mail templates, fixed time issue, and more..
